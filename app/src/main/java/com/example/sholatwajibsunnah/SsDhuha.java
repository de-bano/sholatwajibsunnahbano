...
public class SsDhuha extends AppCompatActivity {
    ...
    public void onCreate (Bundle savedInstanteState){
        ...
        setContentView(R.layout.activity_sunnahdhuha);

        mediaPlayer = MediaPlayer.create(SsDhuha.this, R.raw.hsdhuha);
        mediaPlayer.start();

        WebView = findViewById(R.id.webviewshalatsunnahdhuha);
        String text =
                "&emsp; Shalat dhuha merupakan shalat sunnah yang dikerjakan ketika matahari sudah setinggi tombak hingga menjelang masuknya waktu salat dzuhur. " +
                        "Shalat yang dikerjakan minimal dua rakaat ini juga mempunyai berbagai keutamaan jika dikerjakan. </br> \n" +
                        "&emsp; Waktu menjalankan shalat dhuha yaitu di antara dua shalat wajib, setelah shalat subuh dan sebelum shalat dzuhur. " +
                        "Namun, usai melaksanakan subuh, umat Islam mesti menunggu terbitnya matahari terlebih dahulu. </br>\n" +
                        "&emsp; Pada dasarnya, terdapat dua waktu yang diharamkan untuk mengerjakan shalat, yaitu setelah subuh hingga matahari terbit, dan setelah asar hingga matahari tenggelam. " +
                        "Diriwayatkan Abu Hurairah, \"Sesungguhnya Rasulullah melarang dua shalat; melarang shalat setelah shalat subuh hingga terbit matahari dan setelah ashar hingga terbenam matahari.\" (H.R. Al-Bukhari). </br>\n" +

                        "<p><b> Niat dan Jumlah Rakaat Shalat Dhuha </b></p>" +
                        "Sebelum menjalankan shalat dhuha, terlebih dahulu didahului dengan niat untuk mengerjakannya. " +
                        "Niat tersebut dapat diucapkan dalam hati, dan dapat pula dilafalkan. Bacaan niat salat duha dapat dilafalkan seperti di bawah ini. </p> \n" +
                        " أُصَلِّيْ سُنَّةَ الضُّحَى رَكْعَتَيْنِ لِلهِ تَعَالَى </p>" +
                        "Ushalli sunnatad dhuhā rak‘ataini lillāhi ta‘ālā. </p>" +
                        "Artinya : </br> " +
                        "&emsp; Aku menyengaja shalat sunnah dhuha dua rakaat karena Allah SWT. </p>" +
                        "Salat dhuha dikerjakan minimal dua rakaat. Namun, tidak ada larangan untuk menambah jumlah rakaat shalat dhuha. Nabi Muhammad pernah melakukan shalat dhuha 8 rakaat, berdasarkan riwayat Ummu Hani', \"Nabi saw. pada tahun terjadinya Fathu Makkah beliau shalat dhuha delapan rakaat.” (H.R. Bukhari). " +
                        "Jika shalat dhuha dikerjakan lebih dari dua rakaat, maka pengerjaannya diutamakan sekali salam untuk dua rakaat. " +

                        "Doa Usai Sholat Dhuha </b></p> " +
                        "Setelah mengerjakan shalat dhuha, maka dianjurkan pula untuk membaca beberapa doa sebagai berikut ini:" +
                        " اَللهُمَّ اِنَّ الضُّحَآءَ ضُحَاءُكَ، وَالْبَهَاءَ بَهَاءُكَ، وَالْجَمَالَ جَمَالُكَ، وَالْقُوَّةَ قُوَّتُكَ، وَالْقُدْرَةَ قُدْرَتُكَ، وَالْعِصْمَةَ عِصْمَتُكَ</p>" +
                        "Allāhumma innad dhuhā’a dhuhā’uka, wal bahā’a bahā’uka, wal jamāla jamāluka, wal quwwata quwwatuka, wal qudrata qudratuka, wal ishmata ishmatuka. </p>" +
                        "Artinya : </br> " +
                        "&emsp; Wahai Tuhanku, sungguh dhuha ini adalah dhuha-Mu, keagungan ini adalah keagungan-Mu, keindahan ini adalah keindahan-Mu, kekuatan ini adalah kekuatan-Mu, dan penjagaan ini adalah penjagaan-Mu. </p>" +
                        "\" اَللهُمَّ اِنْ كَانَ رِزْقِى فِى السَّمَآءِ فَأَنْزِلْهُ وَاِنْ كَانَ فِى اْلاَرْضِ فَأَخْرِجْهُ وَاِنْ كَانَ مُعْسِرًا (مُعَسَّرًا) فَيَسِّرْهُ وَاِنْ كَانَ حَرَامًا فَطَهِّرْهُ وَاِنْ كَانَ بَعِيْدًا فَقَرِّبْهُ بِحَقِّ ضُحَاءِكَ وَبَهَاءِكَ وَجَمَالِكَ وَقُوَّتِكَ وَقُدْرَتِكَ آتِنِىْ مَآاَتَيْتَ عِبَادَكَ الصَّالِحِيْنَ </p>" +
                        "Allāhuma in kāna rizqī fis samā’i fa anzilhu, wa inkāna fil ardhi fa akhrijhu, wa inkāna mu’siran (mu‘assaran) fa yassirhu, wa in kāna harāman fa thahhirhu, wa inkāna ba‘īdan fa qarribhu, bi haqqi duhā’ika wa bahā’ika wa jamālika wa quwwatika wa qudratika. ātinī mā atayta ‘ibādakas shālihīn.</p>" +
                        "Artinya : </br>" +
                        "&emsp; Wahai Tuhanku, jika rezekiku berada di atas langit maka turunkanlah. Jika berada di dalam bumi, maka keluarkanlah. Jika sukar atau dipersulit (kudapat), mudahkanlah. Jika (tercampur tanpa sengaja dengan yang) haram, sucikanlah. Jika jauh, dekatkanlah dengan hak duha, keelokan, keindahan, kekuatan, dan kekuasaan-Mu, datangkanlah padaku apa yang Engkau datangkan kepada para hamba-Mu yang saleh. \n" +
        ...
        TextView = findViewById(R.id.textViewshalatsunnahdhuha);
        WebView = findViewById(R.id.webviewshalatsunnahdhuha);
        //load animasi
