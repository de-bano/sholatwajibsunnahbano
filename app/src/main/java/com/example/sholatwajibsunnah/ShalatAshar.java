...
public class ShalatAshar extends AppCompatActivity {
    ...
    public void onCreate (Bundle savedInstanteState){
        ...
        mediaPlayer = MediaPlayer.create(ShalatAshar.this, R.raw.halamanashar);
        mediaPlayer.start();

        WebView = findViewById(R.id.webviewshalatashar);
        String text =
                "<p><b>Niat Sholat</b></p> \n"+
                        ...
                        "<b>Bacaan niat Sholat Ashar Sendirian :</b></p> \n"+
                        "أُصَلِّىْ فَرْضَ الْعَصْرِأَرْبَعَ رَكَعَاتٍ مُسْتَقْبِلَ الْكِبْلَةِ اَدَاءًلِلهِ تَعَا لَى \n</br>" +
                        "<p> &emsp; Ushallii fardhal ashri arba'a raka'aatin mustaqbilal qiblati adaa'an lillaahita'aalaa </p> \n"+
                        "Artinya :</br>"+
                        "&emsp; Saya (berniat) mengerjakan sholat fardhu Ashar sebanyak empat raka’at dengan menghadap kiblat, karena Allah Ta’ala."+

                        "<p><b>Bacaan niat menjadi imam di Sholat Ashar : </b></p>"+
                        "أُصَلِّىْ فَرْضَ الْعَصْرِأَرْبَعَ رَكَعَاتٍ مُسْتَقْبِلَ الْكِبْلَةِ مَأْمُوْمًالِلهِ تَعَا لَى </br> \n"+
                        "<p> &emsp; Ushallii fardhal ashri arba’a raka’aatin mustaqbilal qiblati imaaman lilaahi ta’aalaa. </p>"+
                        "Artinya: </br>"+
                        "&emsp; Saya (berniat) mengerjakan sholat fardhu Ashar sebanyak empat raka’at dengan menghadap kiblat, sebagai imam karena Allah Ta’ala."+

                        "<p><b>Bacaan niat menjadi makmum di Sholat Ashar :</b></p>\n"+
                        "أُصَلِّىْ فَرْضَ الْعَصْرِأَرْبَعَ رَكَعَاتٍ مُسْتَقْبِلَ الْكِبْلَةِ اِمَامًالِلهِ تَعَا لَى</br>\n"+
                        "<p>Ushallii fardhal ashri arba’a raka’aatin mustaqbilal qiblati makmuuman lillaahi ta’aalaa.</p> \n"+
                        "Artinya :</br>"+
                        "&emsp; Saya (berniat) mengerjakan sholat fardhu Ashar sebanyak empat raka’at dengan menghadap kiblat, sebagai makmum, karena Allah Ta’ala."+
        ...
        TextView = findViewById(R.id.textViewshalatashar);
        WebView = findViewById(R.id.webviewshalatashar );
        //load animasi
