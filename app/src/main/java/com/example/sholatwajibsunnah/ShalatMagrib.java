...
public class ShalatMagrib extends AppCompatActivity {
    ...
    public void onCreate (Bundle savedInstanteState){
        ...
        setContentView(R.layout.activity_shalatmagrib);

        mediaPlayer = MediaPlayer.create(ShalatMagrib.this, R.raw.halamanmagrib);
        mediaPlayer.start();


        WebView = findViewById(R.id.webviewshalatmagrib);
        String text =
                "<p><b>Niat Sholat</b></p> \n"+
                        ...
                        "<b>Bacaan niat Sholat Magrib Sendirian :</b></p> \n"+
                        "اُصَلِّى فَرْضَ الْمَغْرِبِ ثَلاَثَ رَكَعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً ِللهِ تَعَالَى \n</br>" +
                        "<p> &emsp; Ushalli fardhol maghribi tsalaata raka’aatim mustaqbilal qiblati adaa-an lillaahi ta’aala </p> \n"+
                        "Artinya :</br>"+
                        "&emsp; Saya (berniat) mengerjakan shalat fardhu Maghrib tiga raka’at menghadap kiblat karena Allah Ta’ala"+

                        "<p><b>Bacaan niat menjadi imam di Sholat Magrib : </b></p>"+
                        "اُصَلِّى فَرْضَ الْمَغْرِبِ ثَلاَثَ رَكَعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً اِمَامًا ِللهِ تَعَالَى </br> \n"+
                        "<p> &emsp; Ushalli fardhol maghribi tsalaatsa raka’aatim mustaqbilal qiblati adaa-an imaaman lillaahi ta’aala </p>"+
                        "Artinya: </br>"+
                        "&emsp; Saya (berniat) mengerjakan shalat fardhu Maghrib tiga raka’at menghadap kiblat sebagai imam karena Allah Ta’ala"+

                        "<p><b>Bacaan niat menjadi makmum di Sholat Magrib :</b></p>\n"+
                        "اُصَلِّى فَرْضَ الْمَغْرِبِ ثَلاَثَ رَكَعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً مَأْمُوْمًا ِللهِ تَعَالَى </br>\n"+
                        "<p>Ushalli fardhol maghribi tsalaatsa raka’aatim mustaqbilal qiblati adaa-an ma’muuman lillaahi ta’aala </p> \n"+
                        "Artinya :</br>"+
                        "&emsp; Saya (berniat) mengerjakan shalat fardhu Maghrib tiga raka’at menghadap kiblat sebagai ma’mum karena Allah Ta’ala"+
        ...
        TextView = findViewById(R.id.textViewshalatmagrib);
        WebView = findViewById(R.id.webviewshalatmagrib );
        //load animasi
