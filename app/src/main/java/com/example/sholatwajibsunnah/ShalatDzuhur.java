...
public class ShalatDzuhur extends AppCompatActivity {
    ...
    public void onCreate (Bundle savedInstanteState){
        ...
        setContentView(R.layout.activity_shalatdzuhur);

        mediaPlayer = MediaPlayer.create(ShalatDzuhur.this, R.raw.halamandzuhur);
        mediaPlayer.start();

    WebView = findViewById(R.id.webviewshalatdzuhur);
    String text =
            "<p><b>Niat Sholat</b></p> \n"+
            ...
            "<b>Bacaan niat Sholat Dzuhur Sendirian :</b></p> \n"+
            "اُصَلِّيْ فَرْضَ الظُّهْرِ أَرْبَعَ رَكَعاَتٍ مُسْتَقْبِلَ الْقِبْلَةِ أَدَاءً لله تَعَالَى\n</br>" +
            "<p> &emsp; Ushallii fardhazh-Zhuhri arba’a raka’aatin mustaqbilal qiblati adaa’an lilaahi ta’aalaa.</p> \n"+
            "Artinya :</br>"+
            "&emsp; Saya (berniat) mengerjakan sholat fardhu Dzuhur sebanyak empat raka’at dengan menghadap kiblat, karena Allah Ta’ala."+
            "<p><b>Bacaan niat menjadi imam di Sholat Dzuhur : </b></p>"+
            "اُصَلِّى فَرْضَ الظُّهْرِاَرْبَعَ رَكَعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً اِمَامًا ِللهِ تَعَالَى </br> \n"+
            "<p> &emsp; Ushallii fardhazh-Zhuhri arba’a raka’aatin mustaqbilal qiblati imaaman lilaahi ta’aalaa. </p>"+
            "Artinya: </br>"+
            "&emsp; Saya (berniat) mengerjakan sholat fardhu Dzuhur sebanyak empat raka’at dengan menghadap kiblat, sebagai imam karena Allah Ta’ala."+
            "<p><b>Bacaan niat menjadi makmum di Sholat Dzuhur :</b></p>\n"+
            "اُصَلِّى فَرْضَ الظُّهْرِاَرْبَعَ رَكَعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً مَأْمُوْمًا ِللهِ تَعَالَى </br>\n"+
            "<p>Ushallii >fardhazh-Zhuhri arba’a raka’aatin mustaqbilal qiblati makmuuman lillaahi ta’aalaa.</p> \n"+
            "Artinya :</br>"+
            "&emsp; Saya (berniat) mengerjakan sholat fardhu Dzuhur sebanyak empat raka’at dengan menghadap kiblat, sebagai makmum, karena Allah Ta’ala."+
    ...
    WebView.loadData("<p style=\"text-align: justify\">"+ text +"<p>", "text/html", "UTF-8");
        ...
        TextView = findViewById(R.id.textViewshalatdzuhur);
        WebView = findViewById(R.id.webviewshalatdzuhur );
        //load animasi
