...
public class ShalatSubuh extends AppCompatActivity {
    ...
    public void onCreate (Bundle savedInstanteState){
        ...
        mediaPlayer = MediaPlayer.create(ShalatSubuh.this, R.raw.halamansubuh);
        mediaPlayer.start();

        WebView = findViewById(R.id.webviewshalatsubuh);
        String text =
                "<p><b>Niat Sholat</b></p> \n"+
                        ...
                        "<b>Bacaan niat Sholat Subuh Sendirian :</b></p> \n"+
                        "اُصَلّى فَرْضَ الصُّبْحِ رَكْعَتَيْنِ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً ِللهِ تَعَالَى \n</br>" +
                        "<p> &emsp; Ushollii fardosh subhi rok'ataini mustaqbilal qiblati adaa-an lillaahi ta'aala. </p> \n"+
                        "Artinya :</br>"+
                        "&emsp; Saya (berniat) mengerjakan shalat subuh dua rakaat menghadap kiblat karena Allah Ta'ala \n" +

                        "<p><b>Bacaan niat menjadi imam di Sholat Subuh : </b></p>"+
                        "اُصَلّى فَرْضَ الصُّبْحِ رَكْعَتَيْنِ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً اِمَامًا ِللهِ تَعَالَى </br> \n"+
                        "<p> &emsp; Ushollii fardhosh subhi rok'ataini mustaqbilal qobilati adaa-an imaman lillaahi ta'aala </p>"+
                        "Artinya: </br>"+
                        "&emsp; Saya (berniat) mengerjakan shalat fardhu Subuh dua raka’at menghadap kiblat sebagai imam karena Allah Ta’ala"+

                        "<p><b>Bacaan niat menjadi makmum di Sholat Subuh :</b></p>\n"+
                        "اُصَلّى فَرْضَ الصُّبْحِ رَكْعَتَيْنِ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً مَأْمُوْمًا ِللهِ تَعَالَى</br>\n"+
                        "<p>Ushollii fardosh subhi rok'ataini mustqbilal qiblati adaa-an ma'muuman lillaahi ta'aala. </p> \n"+
                        "Artinya :</br>"+
                        "&emsp; Saya (berniat) mengerjakan shalat fardhu Subuh dua raka’at menghadap kiblat sebagai ma’mum karena Allah Ta’ala"+
                        ...
                        "<p> &emsp; Bismillahir-rahmanir-rahim. Al-hamdu lillahi rabbil-alamin. Ar-rahmanir-rahim. Maliki yaumid-din. Iyyaka na’budu wa iyaka nasta’in. Ihdinas-siratal-mustaqim. Siratal lazina an’amta ‘alaihim gairil-magdubi ‘alaihim wa lad-dallin.</p>"+
                        ...
                        "<p> &emsp; Bismillahir-rahmanir-rahim. Qul huwallahu ahad. Allahus-samad. Lam yalid wa lam yulad. Wa lam yakul lahu kufuwan ahad.</p> \n" +

                        "<b>Ruku</b></p>\n" +
                        "Setelah selesai membaca Surat atau Ayat dalam Al-Quran Kemudian melakukan ruku’. " +
                        "Yakni dengan cara mengangkat kedua tangan setinggi telinga seraya membaca “Allahu Akbar”, Lalu badan membungkuk, kedua tangan menggengam lutut, mata memandang tempat sujud, punggung dan kepala rata, kemudian membaca doa: </p> \n"+
                        ...
                        "<b>I’tidal</b></p>\n" +
                        "Kemudian melakukan i’tidal, yakni bangun dari ruku’ untuk berdiri tegak, dengan mengangkat kedua tangan sejajar dengan telinga, seraya mengucapkan : </br> \n" +
                        ...
                        "<b>Sujud</b> </p> \n" +
                        "Tata Cara Sujud Yang Benar Kemudian dilanjutkan dengan melakukan gerakan sujud seraya membaca “Allahu Akbar” dengan kedua lutut terlebih dulu, " +
                        "yakni meletakkan Dahi dan Hidung, Kedua Telapak Tangan, kedua lutut dan Kedua Kaki menempel di lantai (Tempat Sholat), seraya membaca doa :</p>  " +
                        ...
                        "\n" +
                        "Tata Cara Iftirasy (Duduk Diantara Dua Sujud)Hendaklah dibaca doa berikut ini : </br>" +
                        ...
                        "Wasallallahu ‘ala Sayyidina Muhammadin nabiyyil ummiyyi. Wa’alaa aalihi washahbihi wasallam. </p>" +
                        "Artinya : </br>"+
                        "%emsp; Ya Allah tunjukkanlah padaku sebagaimana pada mereka yang telah Engkau beri petunjuk\n" +
                        "Dan berilah padaku pengampunan sebagaimana pada mereka yang Engkau beri ampun\n" +
                        "Dan peliharalah aku sebagaimana pada mereka yang Engkau pelihara\n" +
                        "Dan berilah padaku keberkatan sebagaimana yang telah Engkau karuniakan pada mereka\n" +
                        "Dan selamatkan aku dari mara bahaya yang telah Engkau tentukan\n" +
                        "Maka sesungguhnya Engkaulah yang menghukum dan bukan yang kena hukum\n" +
                        "Maka sesungguhnya tidaklah hina pada mereka orang yang Engkau pimpin\n" +
                        "Dan tidak mulia orang yang Engkau musuhi\n" +
                        "Maha Suci Engkau wahai Tuhan kami dan Maha tinggi Engkau\n" +
                        "Maka bagi Engkau segala puji atas yang Engkau hukumkan\n" +
                        "Aku mohon ampun kepada Engkau dan aku bertaubat kepada Engkau\n" +
                        "Dan semoga Allah mencurahkan rahmat dan kesejahteraan atas junjungan kami Nabi Muhammad, keluarga dan para sahabatnya.\n" +
                        "Demikuian Bacaan doa qunut dalam bahasa Arab, Latin dan artinya, semoga dapat memberi kemudahan bagi pembaca dan memberi keberkahan untuk kita semua. Amiin </br>" +
        ...
        TextView = findViewById(R.id.textViewshalatsubuh);
        WebView = findViewById(R.id.webviewshalatsubuh);
        //load animasi
